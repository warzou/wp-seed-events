  ...
  try {
    ...
    await page.setContent(`<!doctype html><html><head><style>
      ...
      @media (max-width: 980px) {
        ...
        .style-matrix .wp-seed-event-date__date,
        .style-matrix .wp-seed-event-date__time,
        .style-matrix .wp-seed-event-date__status { font-size: 18px; line-height: 28px; text-align: center; }
      }
      @media (max-width: 767px) {
        .style-matrix .wp-seed-event-dates__title,
        .style-matrix .wp-seed-event-date__date,
        .style-matrix .wp-seed-event-date__time,
        .style-matrix .wp-seed-event-date__status { font-size: 15px; line-height: 22px; text-align: left; }
      }
      .style-matrix .wp-seed-event-dates__title {
