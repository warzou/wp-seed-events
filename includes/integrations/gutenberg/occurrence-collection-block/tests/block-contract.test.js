...
assert.ok( ! bootstrap.match( /promotion|parcours|grouped/i ) );
assert.ok( ! contextSource.match( /promotion|parcours/i ) );

console.log( 'Gutenberg occurrence collection block contract: OK' );
