...
function wp_seed_events_public_event_data( $post_id ) {
	...
	$illustration_ids  = get_post_meta( $post_id, '_wp_seed_event_illustration_ids', true );
	...
	$flyer_pdf_id      = (int) get_post_meta( $post_id, '_wp_seed_event_flyer_pdf_id', true );
	...
	return array(
		...
		'types'             => wp_seed_events_event_type_labels_for_event( $post_id ),
		'occurrences'       => $occurrences,
		'next_occurrence'   => $next_occurrence,
		'place'             => wp_seed_events_public_event_place_data( $post_id ),
		'people'            => wp_seed_events_public_event_people_data( $post_id ),
