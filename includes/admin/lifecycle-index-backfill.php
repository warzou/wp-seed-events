...
function wp_seed_events_render_lifecycle_index_backfill_panel() {
	...
	<p>Cette opération reconstruit progressivement l’index des dates, du lifecycle, des types et du tri des collections, ainsi que la projection des occurrences. Elle traite au maximum <?php echo esc_html( (string) wp_seed_events_lifecycle_index_batch_size() ); ?> événements par action.</p>
