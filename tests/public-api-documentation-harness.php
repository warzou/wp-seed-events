...
$divi_occurrence_collections = public_docs_read( $root . '/docs/DIVI-OCCURRENCE-COLLECTIONS.md' );
...
public_docs_case( 'Event Data complete top-level keys are documented', function () use ( $event_data ) {
	foreach ( array( 'slug', 'primary_type', 'secondary_types', 'all_types', 'is_pinned', 'programming_status', 'programming_text', 'programming_visible_until', 'active_occurrences', 'display_occurrence', 'promotions', 'parcours_years', 'place_address', 'event_document_filename', 'calendar_all_occurrences_url', 'communication_visuals', 'featured_image_id' ) as $key ) {
