...
2. Installer `wp-seed-events-0.2.0-beta.7.zip` depuis Extensions > Ajouter une extension.
...
2. Remplacer le plugin avec le ZIP `wp-seed-events-0.2.0-beta.7.zip`.
...
Voir [la note de release beta.6](docs/RELEASE-0.2.0-beta.7.md) et [le changelog](CHANGELOG.md) pour les details de release.
