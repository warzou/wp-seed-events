...
2. Installer `wp-seed-events-0.2.0-beta.4.zip` depuis Extensions > Ajouter une extension.
...
2. Remplacer le plugin avec le ZIP `wp-seed-events-0.2.0-beta.4.zip`.
...
Voir [la note de release beta.4](docs/RELEASE-0.2.0-beta.4.md) et [le changelog](CHANGELOG.md) pour les details de release.
